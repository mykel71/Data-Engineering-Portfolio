# Michael Shepherd Munemo - A Data Engineering Portfolio

*Exploring Data Realms: Michael embarks on a journey through data engineering after a year in **Software Development**, followed by years specializing in **Data Engineering***
...
**Based:** Centurion, Gauteng South Africa

**Status:** Currently Open for a **Data Engineer** Job

**Contact me:** Michael (+27) 64 543 9386

**Email:** shepherd.munemo@outlook.com

**Linkedin**: [Click Here](https://www.linkedin.com/in/munemoshepherdmichael/)

Hello, my name is Michael Shepherd Munemo! An experienced **Big Data Engineer** & **Developer** with a proven track record in Insurance, Corporate, and FinTech sectors. Adept at writing high-performance, reliable, and maintainable code, with deep expertise in building highly scalable infrastructure using Big Data technologies, including Hadoop, SQL, Python, and Spark. Skilled in applying Test-Driven Development and Performance Optimization strategies to enhance data accuracy and reduce processing time. A collaborative problem-solver who brings innovation and efficiency to the team, with a results-driven approach to data engineering.

During my tenure at AAT Business Solutions, I have spearheaded various projects centered around data engineering and business intelligence. Some of my key responsibilities included **planning, building, and maintaining data warehouses, designing, and developing ETL/ELT processes** using tools like SSIS and Azure Data Factory, and creating Power BI dashboards for data visualization. Additionally, I have experience in migrating on-prem databases to Azure cloud platforms and implementing row-level security to ensure data governance compliance.

Moreover, my previous roles at VaJere Holdings Pty Ltd and Bolu Globe IT have equipped me with a diverse skill set ranging from data modeling and SQL database development to predictive analytics and machine learning. I have a proven track record of collaborating with cross-functional teams to gather requirements, develop data pipelines, and deliver actionable insights through intuitive visualizations.
I am particularly excited about the opportunity to leverage my expertise in Microsoft Azure and BI development to drive innovation and efficiency within your organization. Furthermore, my commitment to staying current with emerging technologies is reflected in my pursuit of role-based certifications such as Azure Data Engineer Associate, Azure Database Associate etc..

I am confident that my background in data engineering and BI development, combined with my passion for problem-solving and continuous learning, make me an asset. I am eager to discuss how my skills and experience align with your organization's needs and contribute to its success.
...
At the beginning of my journey into the realm of data, I initially aspired to acquire a career in Data Analysis. However, as my love for tech progressed, I dug deeply into various subjects and consistently be the best at, achieving the highest distinctions across disciplines such as **Object-oriented Programming** and **Software developing**. While my focus wasn’t solely on excelling in these areas, my commitment to excellence resulted in commendable performance. As I approached the end of my first year, I realized the potential for synergy between my aptitude in **Data Analytics** and my proficiency in **Software Development**. This realization led me to the combination role of the both 2 fields: As a **Data Engineer** - which was the best decision I have made in my lifetime.

### Why not Data Scientist or AI Scientist?

In fact, consider becoming a **Data Scientist**, who would spend their entire working day researching ways to make machine learning algorithms more accurate and identifying key learning characteristics for a dataset, or an **Artificial Intelligence Scientist**, who would create extremely sophisticated language models and dedicate their entire life to refining them. Yep, I had some thought, but eventually, I just love being a **Data Engineer**, perhaps an angel has led me this career path, who knows.
